...
class TwoLayerNet(object):
    ...
    def __init__(self, input_dim=3*32*32, hidden_dim=100, num_classes=10,
        ...
        ############################################################################
        self.params['W1'] = np.random.normal(size =(input_dim,hidden_dim), scale = weight_scale, loc = 0.0 )
        self.params['b1'] = np.zeros(hidden_dim)
        self.params['W2'] = np.random.normal(size =(hidden_dim,num_classes), scale = weight_scale, loc = 0.0 )
    ...
    def loss(self, X, y=None):
        ...
        dz1,grads['W2'],grads['b2'] = affine_backward(grad,cache2)
        dx,grads['W1'],grads['b1'] = affine_relu_backward(dz1,cache1)
